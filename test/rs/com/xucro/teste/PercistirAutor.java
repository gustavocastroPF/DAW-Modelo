...
public class PercistirAutor {
    ...
    public static void main(String[] args) {
        ...
        u.setStatus(true);
        u.setDistribuidor(true);
        u.setRedeSocial("facebook.com/gustavo");
        u.setSiteAutorDesenvolvedor("www.gustavo.com");
        u.setSiteDistribuidor("www.gustavoDistribuidor.com");
        //VALIDAÇÃO
        Validator validador = Validation.buildDefaultValidatorFactory().getValidator();
        Set<ConstraintViolation<Autor>> erros = validador.validate(u);
        if (erros.size() > 0) {
